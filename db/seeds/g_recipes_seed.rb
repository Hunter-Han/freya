pomegranate_sorbet = Recipe.new(
  ingredient: @pomegranate,
  name: "Pomegranate Sorbet",
  hours_preparation: 4,
  description: "Pomegranates have a sweet flavour with a hint of sharpness and a wonderful colour. This sorbet makes the most of these qualities and is simple to make.",
  instructions: "1. Cut the pomegranates in half and reserve a few of the seeds for decoration. Squeeze as you would a lemon or an orange, to produce about 500ml juice. Sieve to remove any pips or pith.\n
  2. Stir the sugar, lemon juice and grenadine into the pomegranate juice and stir until the sugar has dissolved. Pour the mixture into a plastic freezer container, preferably square or rectangular, with a flat base - a 1-litre capacity clean and dry ice cream container is ideal. Then cover and place in the coldest part of the freezer.\n
  3. After about 1-1½ hours, the mixture should have frozen around the edges. Use an electric beater or balloon whist to beat the sorbet until it becomes a uniform slush. Quickly return to the freezer.\n
  4. Repeat this process twice, leaving the mixture to partially freeze between each beating. After the final stage, the sorbet will need at least 45 minutes of further freezing before serving. To serve, decorate with reserved pomegranate seeds.",
  shopping_list: "5-6 pomegranates\n150g caster sugar\n3 tbsp lemon juice\n1 tbsp Monin Sirop de Grenadine\nHandful of blueberries",
  serves: 6
  )
...
pomegranate_relish = Recipe.new(
  ...
  shopping_list: "1 cup pomegranate juice\n1/2 cup pomegranate seeds (optional)\n1 bag (12 ounces) fresh or frozen cranberries\n1/2 cup packed dark-brown sugar\n1 large shallot, finely chopped.",
  serves: 10
  )
